...
const checks = [
  ...
  ['artifact verification tarball docs', 'verify-packed-tarball-contents.mjs', artifactVerification],
  ...
  ['packed contents extracts tarball', 'tar', packedContents],
  ['packed contents checks main', 'main', packedContents],
  ['packed contents checks types', 'types', packedContents],
  ['packed contents checks export targets', 'assertExportPaths', packedContents],
  ['packed contents checks package-local targets', 'must stay inside the package', packedContents],
  ['packed contents checks parent directory', 'must not contain parent directory traversal', packedContents],
